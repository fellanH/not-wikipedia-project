...
| --- | -------------------------- | -------------- | --------- |
| 1.1 | Add Vitest                 | Testing        | `DONE`    |
| 1.2 | Tests: wiki-next-task      | Testing        | `DONE`    |
| 1.3 | Tests: wiki-create-article | Testing        | `DONE`    |
| 1.4 | Tests: wiki-edit-article   | Testing        | `DONE`    |
| 1.5 | Tests: wiki-discover       | Testing        | `DONE`    |
| 1.6 | Tests: wiki-git-publish    | Testing        | `DONE`    |
| 2.1 | Fix silent DB errors       | Error Handling | `DONE`    |
| 2.2 | Git push retry             | Error Handling | `DONE`    |
| 2.3 | HTML validation            | Error Handling | `PENDING` |
| 2.5 | Zod schemas                | Error Handling | `PENDING` |
